...
from tajia.utils import get_xmind_testsuites, get_xmind_testcase_list
...
def init():
    ...
    if not exists(DATABASE):
        init_db()
    app.logger.info('Congratulations! the tajia webtool database has initialized successfully!')
